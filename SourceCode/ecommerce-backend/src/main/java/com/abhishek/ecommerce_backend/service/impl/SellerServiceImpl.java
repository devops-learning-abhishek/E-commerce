...
import com.abhishek.ecommerce_backend.repository.AddressRepository;
...
public class SellerServiceImpl implements SellerService{
    ...
    public Seller updateSeller(Long id, Seller seller) throws SellerException {
        ...
        if (seller.getBusinessDetails() != null 
                    && seller.getBusinessDetails().getBusinnessName() != null
        ) {
            existingSeller.getBusinessDetails().setBusinnessName(seller.getBusinessDetails().getBusinnessName());
        }
