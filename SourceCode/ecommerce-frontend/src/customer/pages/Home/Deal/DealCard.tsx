...
const DealCard = ({ item }: { item: Deal }) => {
  return (
    <div className="w-[10rem] cursor-pointer">
      <img
        className="border-x-[7px] border-t-[7px] border-lime-600 w-full h-[12rem] object-cover object-top"
        src={item.category.image} alt="" />
      <div className="border-4 border-lime-600 bg-lime-600 text-black p-2 text-center">
